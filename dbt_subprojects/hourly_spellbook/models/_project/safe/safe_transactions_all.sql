{{ config(
        ...
        post_hook='{{ expose_spells(\'["arbitrum","avalanche_c","base","blast","bnb","celo","ethereum","fantom","gnosis","goerli","linea","mantle","optimism","polygon","ronin","scroll","worldchain","zkevm","zksync"]\',
                                "project",
                                "safe",
                                \'["kryptaki", "danielpartida", "safe_intern"]\') }}'
        )
}}
